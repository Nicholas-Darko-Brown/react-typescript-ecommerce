...
import { StoreItemProps } from '../components/StoreItem/StoreItem';
import { useShoppingCart } from '../context/ShoppingCartContext';
import { api } from '../services/api';
import { ProductDetails, StoreProduct } from '../types/models';
...
const StoreDetails = () => {
  ...
  const notify = () => toast.success(`${details?.productDetails.title} has been added to cart.`);
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mb-4 items-center">
                  <span className="flex items-center">
                    ...
                    <span className="text-gray-600 ml-3"> {details?.productDetails.rating.rate} Reviews</span>
                  </span>
                  <span className='ml-3 pl-3 py-2 border-l-2 border-gray-200'> Count: {details?.productDetails.rating.count} </span>
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                  ...
                  <div className="ml-6">
                    <span>Stock: {details?.productDetails.stock}</span>
                  </div>
                ...
                <div className="flex">
                  ...
                  {color ?
                    <button onClick={handleColorChange} className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-pink-500 ml-4">
                      <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path>
                      </svg>
                    </button>
                    :
                    <button onClick={handleColorChange} className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                      <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path>
                      </svg>
                    </button>
