  ...
  return (
    <div className="relative">
      ...
      <section className="mb-40 relative">
        ...
        <div style={{ backgroundImage: `url("https://images.unsplash.com/photo-1630304566704-780606056458?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")`, objectFit: "cover" }} className="relative div-two overflow-hidden bg-no-repeat bg-cover"></div>
